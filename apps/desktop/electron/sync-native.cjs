...
const source = join(workspaceRoot, "node_modules", "better-sqlite3", "build");
const targetModule = join(desktopRoot, ".next", "standalone", "node_modules", "better-sqlite3");
...
verifyNativeAddon(require("electron"), targetModule, { cwd: workspaceRoot, runtimeName: "Electron standalone" });
