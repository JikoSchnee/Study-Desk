...
export function CardLibrary() {
  ...
  return <PageLayout className="cards-library-page">{detail && <CardDetailsDialog card={detail.card} learning={detail.learning} onClose={() => setDetail(null)} />}{difficultyPreviewOpen && <DifficultyPreviewDialog onClose={() => setDifficultyPreviewOpen(false)} />}<LLMConfigurationDialog open={needsLLMConfiguration} onClose={() => setNeedsLLMConfiguration(false)} purpose="AI 补充问法" />
