    ...
    <section className="card-editor-modal card-details-modal" role="dialog" aria-modal="true" aria-labelledby="card-details-title">
      ...
      <div className="card-details-body">
        ...
        <section className="learning-overview" aria-label="学习概况">
          ...
          <div className="learning-stat score"><ChartNoAxesCombined size={20}/><span>平均得分</span><strong>{learning.averageScore === null ? "—" : `${learning.averageScore} 分`}</strong><small>{learning.hasInitialPractice ? `${learning.practiceCount} 次练习 · ${learning.reviewCount} 次复习` : "等待首次练习"}</small></div>
        </section>
