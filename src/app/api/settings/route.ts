...
import { getAppSettings, saveAppSettings, saveEmbeddingModelSource } from "@/lib/settings";
...
export async function PATCH(request: Request) {
  ...
  return NextResponse.json({ ...getAppSettings(), embeddingModelSource: saveEmbeddingModelSource(input.embeddingModelSource) });
}
