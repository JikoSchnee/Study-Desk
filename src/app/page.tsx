...
export default function TodayPage() {
  ...
  return <>
    ...
    <section className="today-hero">
      <div><p className="eyebrow"><Flame size={15}/> 今天的训练</p><h1>即刻开始</h1><p>从一个小问题开始，今天也能让表达更清楚一点。</p><div className="hero-actions"><Link href="/library"><Button><BookOpen size={17}/> 学习</Button></Link><Link href="/review"><Button variant="secondary"><RefreshCw size={17}/> 复习</Button></Link><Link href="/interview"><Button variant="outline"><Mic2 size={17}/> 模拟面试</Button></Link><TourButton tour="today" /></div></div>
